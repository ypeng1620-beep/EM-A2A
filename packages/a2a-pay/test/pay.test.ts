...
const mockTronAdapter = {
  ...
  transferStablecoin: vi.fn().mockResolvedValue({
    txHash: 'tx_mock_001', blockNumber: 12345,
    from: 'TABC123', to: 'TDEF456', token: 'USDC', amount: '1000000',
    fee: '10000', status: 'confirmed', timestamp: Date.now(), chainId: 'tron:mainnet',
  }),
